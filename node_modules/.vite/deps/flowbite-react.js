...
function Popover({ children, content, theme: customTheme = {}, arrow: arrow2 = true, trigger = "click", initialOpen, open: controlledOpen, onOpenChange: setControlledOpen, placement: theirPlacement = "bottom", ...props }) {
  const [uncontrolledOpen, setUncontrolledOpen] = (0, import_react36.useState)(Boolean(initialOpen));
  ...
  if (!(0, import_react36.isValidElement)(children)) {
    throw Error("Invalid target element");
  }
  const target = (0, import_react36.useMemo)(() => {
    return (0, import_react36.cloneElement)(children, getReferenceProps({
      ref,
...
var Select = (0, import_react41.forwardRef)(({ addon, children, className, color = "gray", helperText, icon: Icon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
...
var Textarea = (0, import_react59.forwardRef)(({ className, color = "gray", helperText, shadow, theme: customTheme = {}, ...props }, ref) => {
...
var ToggleSwitch = (0, import_react65.forwardRef)(({ checked, className, color = "blue", sizing = "md", disabled, label, name, onChange, theme: customTheme = {}, ...props }, ref) => {
